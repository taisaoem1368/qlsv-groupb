          ...
          <form id="form-ex" action="{{Route('postExportTTKL')}}" method="post">
            ...
            <div class="form-row">
              <div class="form-group col-md-2 offset-md-2">
                <label>Học kì<span id="required-value">*</span></label>
              ...
              <div class="form-group col-md-2">
                <label>Năm Học<span id="required-value">*</span></label>
             ...
             <div class="form-group col-md-2">
              <label>Đuôi File<span id="required-value">*</span></label>
    ...
    if(number == 0)
      ...
      while(i < number)
      {
        a += `<div class="col-md-3 item-merge">
                <b>From:<span id="required-value">*</span></b><input type="text" name="merge[`+i+`][from]" placeholder="vd: A2 (Nhập chữ Hoa)">
                <b>To:<span id="required-value">*</span></b><input type="text" name="merge[`+i+`][to]" placeholder="vd: C6 (Nhập chữ Hoa)">
    ...
    var a = `<div class="custom-export-table">
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              <label><b>Viết từ dòng:</b><span id="required-value">*</span> </label>
