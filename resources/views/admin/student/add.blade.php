...
<div id="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="form-add">
                <div class="container">
                    <form class="col-xs-12 add-form" action="{{route('postAddStudent')}}" method="post">
            ...
            @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mr-md-auto">
                                <select class="form-control majorselect" name="student_major_id">
                                    <?php if (@$major) : ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mr-md-auto">
                                <select class="form-control classselect" name="student_class_id" required>
                                    <?php if (@$class) : ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mr-md-auto">
                                <input type="text" name="student_fullname" class="form-control" placeholder="Họ Tên" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Ngày sinh</label>
                            <div class="col-sm-4 mr-md-auto">
                                <input type="date" format="dd/mm/YYYY" name="student_birth" class="form-control" placeholder="Ngày sinh">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Bậc đào tạo</label>
                            <div class="col-sm-4 mr-md-auto">
                                <input type="text" name="student_type_edu" class="form-control" placeholder="Bậc đào tạo">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mr-md-auto">
                                <input type="text" name="student_level_edu" class="form-control" placeholder="Loại hình đào tạo">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mr-md-auto">
                                <textarea name="student_contact" class="form-control" placeholder="Thông tin liên hệ"></textarea>
                            </div>
                        </div>
